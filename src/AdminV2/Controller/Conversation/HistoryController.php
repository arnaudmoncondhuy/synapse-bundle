...
namespace ArnaudMoncondhuy\SynapseBundle\AdminV2\Controller\Conversation;
...
/**
 * Historique global des conversations — Admin V2 (accès Break-Glass)
 *
 ...
 */
#[Route('/synapse/admin-v2/conversation/historique', name: 'synapse_v2_admin_history')]
class HistoryController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        ...
        return $this->render('@Synapse/admin_v2/conversation/history.html.twig', [
