...
namespace ArnaudMoncondhuy\SynapseBundle\AdminV2\Controller\Systeme;
 ...
 */
#[Route('/synapse/admin-v2/systeme/sante', name: 'synapse_v2_admin_health')]
class HealthController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('@Synapse/admin_v2/systeme/health.html.twig', [
            'checks'           => $checks,
