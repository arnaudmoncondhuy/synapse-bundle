        ...
        $treeBuilder->getRootNode()
            ...
            ->arrayNode('persistence')
                ...
                ->children()
                    ...
                    ->end()
                    ->scalarNode('conversation_repository')
                        ->defaultNull()
                        ->info('FQCN du repository Conversation concret. Si renseigné, le bundle enregistre automatiquement l\'alias DI.')
                    ->end()
                    ->scalarNode('message_repository')
                        ->defaultNull()
                        ->info('FQCN du repository Message concret. Si renseigné, le bundle enregistre automatiquement l\'alias DI.')
                    ->end()
                ->end()
            ->end()
