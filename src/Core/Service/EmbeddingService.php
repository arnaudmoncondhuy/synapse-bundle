...
namespace ArnaudMoncondhuy\SynapseBundle\Core\Service;
...
use ArnaudMoncondhuy\SynapseBundle\Shared\Event\SynapseEmbeddingCompletedEvent;
...
class EmbeddingService
{
    ...
    public function __construct(
        ...
        private \ArnaudMoncondhuy\SynapseBundle\Storage\Repository\SynapseConfigRepository $configRepository,
    ) {
