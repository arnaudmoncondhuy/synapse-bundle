...
> [!TIP]
> **Action Différée** : SynapseBundle fournit une commande console `synapse:purge` qui utilise cette interface. Vous pouvez planifier cette commande via un **CRON** pour un nettoyage quotidien.
