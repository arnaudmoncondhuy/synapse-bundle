...
*   **Format par défaut** : SynapseBundle inclut déjà un formateur conforme au standard OpenAI. N'implémentez cette interface que si vous avez des besoins de transformation de données très spécifiques.
