...
SynapseBundle est conçu comme un **kit de construction**. Chaque brique majeure est définie par une interface (un "contrat") que vous pouvez réimplémenter pour adapter le bundle à vos besoins exacts.
...
> [!TIP]
> **Pas besoin de tout implémenter !** SynapseBundle arrive avec des implémentations par défaut pour la plupart de ces briques. Vous ne remplacez que ce dont vous avez réellement besoin.
