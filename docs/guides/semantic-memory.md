...
La **Mémoire Sémantique** de SynapseBundle permet à l'IA de retenir des informations importantes sur l'utilisateur au fil des conversations, avec son **consentement explicite**.
...
- Un embedding provider configuré (voir [Configuration des Embeddings](../admin/interface.md))
