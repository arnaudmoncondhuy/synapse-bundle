...
- **Synapse Core** (`arnaudmoncondhuy/synapse-core`) : API headless, contrats, **Accounting (coûts)**, **Quotas**, Agents & Tons, RAG, **Support Multilingue**, CLI (**Doctor**).
...
- **[Synapse Core]** : Prise en main, Accounting, Quotas, Agents, RAG et CLI (Doctor).
