...
/**
 * Gestion des tons de réponse de l'IA — Admin V2
 *
 ...
 */
#[Route('/synapse/admin-v2/intelligence/tones', name: 'synapse_v2_admin_tones')]
class ToneController extends AbstractController
{
    ...
    public function index(): Response
    {
        ...
        return $this->render('@Synapse/admin_v2/intelligence/tones.html.twig', [
            'tones' => $tones,
        ]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        if ($request->isMethod('POST')) {
            $this->validateCsrfToken($request, $this->csrfTokenManager, 'synapse_v2_tone_edit');
            ...
            return $this->redirectToRoute('synapse_v2_admin_tones');
        }

        return $this->render('@Synapse/admin_v2/intelligence/tone_edit.html.twig', [
            'tone'   => $tone,
            'is_new' => true,
        ]);
    }
    ...
    {
        $this->denyAccessUnlessAdmin($this->permissionChecker);
        $this->validateCsrfToken($request, $this->csrfTokenManager, 'synapse_v2_tone_toggle_' . $tone->getId());
    ...
    {
        $this->denyAccessUnlessAdmin($this->permissionChecker);
        $this->validateCsrfToken($request, $this->csrfTokenManager, 'synapse_v2_tone_delete_' . $tone->getId());
