 ...
 *     },
 * }
 * @psalm-type SynapseConfig = array{
 *     personas_path?: scalar|Param|null, // Chemin absolu vers votre fichier personas.json personnalisé. Si null, utilise le fichier par défaut du bundle. // Default: null
 *     persistence?: array{
 ...
 *         key?: scalar|Param|null, // Clé de chiffrement (32 bytes, ex: %env(SYNAPSE_ENCRYPTION_KEY)%) // Default: null
 *     },
 *     token_tracking?: array{
 *         enabled?: bool|Param, // Activer le tracking des tokens et calcul des coûts // Default: false
 ...
 *     },
 *     retention?: array{
 *         days?: int|Param, // Durée de rétention RGPD (jours) // Default: 30
 *     },
 *     security?: array{
 *         permission_checker?: scalar|Param|null, // Stratégie de vérification des permissions : "default", "none", ou service ID personnalisé // Default: "default"
 *         admin_role?: scalar|Param|null, // Rôle Symfony requis pour accéder à l'admin et voir toutes les conversations // Default: "ROLE_ADMIN"
 *     },
 *     context?: array{
 *         provider?: scalar|Param|null, // Fournisseur de contexte : "default", "user_aware", ou service ID personnalisé // Default: "default"
 *         language?: scalar|Param|null, // Langue par défaut pour les prompts système (fr, en) // Default: "fr"
 *         base_identity?: scalar|Param|null, // Identité de base personnalisée (override la valeur par défaut) // Default: null
 *     },
 *     admin?: array{
 *         enabled?: bool|Param, // Activer l'interface d'administration // Default: false
 *         route_prefix?: scalar|Param|null, // Préfixe des routes admin // Default: "/synapse/admin"
 *         default_color?: scalar|Param|null, // Couleur par défaut du module (hex) // Default: "#8b5cf6"
 *         default_icon?: scalar|Param|null, // Icône par défaut du module // Default: "robot"
 *     },
 *     ui?: array{
 *         sidebar_enabled?: bool|Param, // Activer la sidebar (historique conversations) // Default: true
 *         layout_mode?: scalar|Param|null, // Mode de layout admin : "standalone" (avec sidebar) ou "module" // Default: "standalone"
 *     },
 * }
