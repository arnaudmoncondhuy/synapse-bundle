 ...
 *     model?: scalar|null|Param, // Le modèle Gemini à utiliser pour la génération (défaut: gemini-2.5-flash-lite). // Default: "gemini-2.5-flash-lite"
 *     personas_path?: scalar|null|Param, // Chemin absolu vers votre fichier personas.json personnalisé. Si null, utilise le fichier par défaut du bundle. // Default: null
 * }
